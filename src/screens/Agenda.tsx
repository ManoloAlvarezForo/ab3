    ...
    <SafeAreaView style={{flex: 1}}>
      <AgendaWix
        ...
        items={{
          ...
          '2024-07-20': [
            {
              name: 'Maria Lanchipa Prado',
              address: 'Av. Tomatada de Cordero',
              type: 'bibleCourse',
              time: '04:30 PM',
            },
          ],
          ...
          '2024-07-22': [
            {
              name: 'Martinica Comunica',
              address: 'Av. Dorbigni esq tunupa',
              type: 'revisit',
              time: '11:30 AM',
            },
            {
              name: 'Juan Choque Quizpe',
              address: 'Manchacota cerca ladrillo',
              type: 'bibleCourse',
              time: '07:00 PM',
            },
          ],
